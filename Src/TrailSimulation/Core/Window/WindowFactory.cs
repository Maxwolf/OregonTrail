...
namespace TrailSimulation.Core
{
    ...
    public sealed class WindowFactory
    {
        ...
        /// </summary>
        private Dictionary<SimulationModule, Type> Windows { get; }
        ...
        /// </summary>
        public Dictionary<SimulationModule, int> AttachCount { get; }
        ...
        public IWindow CreateWindow(SimulationModule windows)
        {
