...
namespace TrailSimulation.Core
{
    ...
    public sealed class RequiredWindowAttribute : Attribute
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="T:TrailSimulation.Core.RequiredWindowAttribute" /> class.
        /// </summary>
        public RequiredWindowAttribute(Windows parentWindow)
        {
