...
namespace TrailSimulation.Core
{
    ...
    /// </summary>
    public sealed class WindowManagerModule : SimulationModule
    {
        /// <summary>
        ...
        public WindowManagerModule()
        {
            ...
            Modes = new Dictionary<Windows, IWindow>();
        ...
        /// </summary>
        public Dictionary<Windows, int> RunCount
        {
            get { return _windowFactory.AttachCount; }
        }

        /// <summary>
        ///     References the current active game Windows, or the last attached game Windows in the simulation.
        /// </summary>
        public IWindow ActiveMode
        {
        ...
        /// </summary>
        internal Dictionary<Windows, IWindow> Modes { get; }
        ...
        private bool RemoveDirtyModes()
        {
            ...
            var copyModes = new Dictionary<Windows, IWindow>(Modes);
            var updatedModes = false;
