...
{
    /// <summary>
    ///     Makes the player lose time on the trail by forcing them to rest for random amount of time until the trail evens
    ///     out.
    /// </summary>
    [DirectorEvent(EventCategory.Weather)]
    public sealed class RoughTrail : EventProduct
    {
        /// <summary>
        ...
        /// </param>
        public RoughTrail(EventCategory category) : base(category)
        {
        }
