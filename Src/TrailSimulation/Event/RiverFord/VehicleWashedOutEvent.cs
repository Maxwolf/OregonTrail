...
namespace TrailSimulation.Event
{
    ...
    /// </summary>
    [DirectorEvent(EventCategory.RiverFord)]
    public sealed class VehicleWashedOutEvent : EventItemDestroyer
    {
        /// <summary>
        ...
        /// </param>
        public VehicleWashedOutEvent(EventCategory category) : base(category)
        {
        }
