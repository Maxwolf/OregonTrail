...
namespace TrailSimulation.Game
{
    ...
    /// </summary>
    public sealed class ClimateModule : Module
    {
                ...
                case ClimateClassification.Polar:
                    _averageTemperatures = new List<ClimateData>
                    {
                        new ClimateData(Month.January, -2.9f, -0.2f, -5.5f, 15,
                            1),
                        new ClimateData(Month.February, -9.5f, -6.3f, -11.6f,
                            21.2f, 2),
                        new ClimateData(Month.March, -18.2f, -14, -21.1f,
                            24.1f, 4),
                        new ClimateData(Month.April, -20.7f, -17.4f, -24.9f,
                            18.4f, 2),
                        new ClimateData(Month.May, -21.7f, -19, -27.1f, 18.4f,
                            1),
                        new ClimateData(Month.June, -23, -19.1f, -27.3f, 24.9f,
                            4),
                        new ClimateData(Month.July, -25.7f, -21.7f, -30.1f,
                            15.6f, 5),
                        new ClimateData(Month.August, -26.1f, -22.8f, -31.8f,
                            11.3f, 3),
                        new ClimateData(Month.September, -24.6f, -20.8f,
                            -29.4f, 11.8f, 2),
                        new ClimateData(Month.October, -18.9f, -15.5f, -23.4f,
                            9.7f, 3),
                        new ClimateData(Month.November, -9.7f, -6.7f, -12.7f,
                            9.5f, 4),
                        new ClimateData(Month.December, -3.4f, -0.8f, -6,
                            15.7f, 2)
                    };
                    break;
                ...
                case ClimateClassification.Moderate:
                    _averageTemperatures = new List<ClimateData>
                    {
                        new ClimateData(Month.January, -6.1f, 8.6f, -8.8f, 40,
                            85),
                        new ClimateData(Month.February, -6f, 10.2f, -8.8f, 31,
                            82),
                        new ClimateData(Month.March, -1.4f, 14.9f, -4.2f, 35,
                            77),
                        new ClimateData(Month.April, 4.4f, 25.3f, 1.0f, 33, 71),
                        new ClimateData(Month.May, 10.9f, 30.9f, 6.6f, 38, 64),
                        new ClimateData(Month.June, 15.8f, 34.6f, 11.8f, 64,
                            66),
                        new ClimateData(Month.July, 18.1f, 35.3f, 14.4f, 78,
                            69),
                        new ClimateData(Month.August, 16.4f, 37.1f, 13, 77, 74),
                        new ClimateData(Month.September, 11.0f, 30.4f, 8.1f,
                            67, 79),
                        new ClimateData(Month.October, 5.6f, 21.0f, 3.4f, 65,
                            82),
                        new ClimateData(Month.November, -0.1f, 12.3f, -2.1f,
                            56, 85),
                        new ClimateData(Month.December, -3.9f, 10.9f, -6.4f,
                            49, 86)
                    };
                    break;
        ...
        public override void OnTick(bool systemTick)
        {
            ...
            var possibleTemperature = GameSimulationApp.Instance.Randomizer.Next((int) possibleClimate.MeanDailyMin,
                (int) possibleClimate.MeanDailyMax);

            // Make it so climate doesn't change every single day (ex. 4 days of clear skies, 2 of rain).
            var someRandom = GameSimulationApp.Instance.Randomizer.NextDouble();
            ...
            if (possibleTemperature > possibleClimate.AverageDailyTemperature)
            {
                ...
                if (GameSimulationApp.Instance.Randomizer.NextBool())
                {
                    ...
                    switch (GameSimulationApp.Instance.Randomizer.Next(5))
                    {
                        case 0:
                        ...
                        case 4:
                            ...
                            DisasterChance = (float) GameSimulationApp.Instance.Randomizer.NextDouble();
                            break;
                        case 5:
            ...
            else
            {
                ...
                if (possibleClimate.MeanMonthlyRainfall > GameSimulationApp.Instance.Randomizer.NextDouble())
                {
                    // Terrible weather!
                    switch (GameSimulationApp.Instance.Randomizer.Next(8))
                    {
                        case 0:
            ...
            if (InsideTemperature > OutsideTemperature)
            {
                if (ClimateClassificationType == ClimateClassification.Polar)
                {
                    ...
                    InsideTemperature -= GameSimulationApp.Instance.Randomizer.Next(1, 3);
                }
                else
                {
