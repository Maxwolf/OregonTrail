...
namespace TrailSimulation.Game
{
    ...
    public sealed class GraveyardModule : Module
    {
        ...
        /// </summary>
        /// <param name="odometer">
        /// Number of miles the vehicle has traveled (to check for grave-site).
        /// </param>
        /// <param name="foundTombstone">
        /// Tombstone item returned from this mile marker if one exists, NULL if no tombstone found.
        /// </param>
        ...
        /// </summary>
        /// <param name="odemeter">
        /// Current mile marker the vehicle is located at on the trail.
        /// </param>
        /// <returns>
        /// TRUE if tombstone exists for this mile marker.
        /// </returns>
