...
namespace TrailSimulation.Game
{
    ...
    public sealed class InputPlayerNameState : Form<MainMenuInfo>
    {
        /// <summary>
        ...
        /// </summary>
        public InputPlayerNameState(IWindow gameMode) : base(gameMode)
        {
        }
        ...
        public override void OnInputBufferReturned(string input)
        {
            ...
            if (string.IsNullOrEmpty(input) || string.IsNullOrWhiteSpace(input))
            {
                ...
                SetForm(typeof (ConfirmPlayerNamesState));
                return;
            }
