...
namespace TrailSimulation.Game
{
    ...
    public sealed class BuyInitialItemsState : DialogState<MainMenuInfo>
    {
        ...
        /// </summary>
        public BuyInitialItemsState(IWindow gameMode) : base(gameMode)
        {
        ...
        {
            //parentGameMode.State = new IntroduceStoreState(parentGameMode, UserData);
            SetForm(typeof (IntroduceStoreState));
        }
    }
}