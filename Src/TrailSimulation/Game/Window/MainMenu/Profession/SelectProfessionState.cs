...
namespace TrailSimulation.Game
{
    ...
    public sealed class SelectProfessionState : Form<MainMenuInfo>
    {
        /// <summary>
        ...
        /// </summary>
        public SelectProfessionState(IWindow gameMode) : base(gameMode)
        {
        }
        ...
        public override void OnInputBufferReturned(string input)
        {
            ...
            switch (professionChoice)
            {
                case Profession.Banker:
                    ...
                    SetForm(typeof (InputPlayerNameState));
                    break;
                ...
                default:
                    ...
                    UserData.StartingMonies = 1600;
                    UserData.PlayerNameIndex = 0;
                    SetForm(typeof (ProfessionAdviceState));
                    break;
            }
        }
    }
