...
namespace TrailSimulation.Game
{
    ...
    {
        public ProfessionAdviceState(IWindow gameMode) : base(gameMode)
        {
        }
        ...
        {
            //parentGameMode.State = new SelectProfessionState(parentGameMode, UserData);
            SetForm(typeof (SelectProfessionState));
        }
    }
}