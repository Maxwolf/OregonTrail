...
{
    /// <summary>
    ///     Erases all the saved JSON TombstoneItem epitaphs on the disk so other players will not encounter them, new ones can be
    ///     created then.
    /// </summary>
    ...
    public sealed class EraseTombstone : InputForm<NewGameInfo>
    {
        ...
        /// </summary>
        public EraseTombstone(IWindow gameMode) : base(gameMode)
        {
        }
