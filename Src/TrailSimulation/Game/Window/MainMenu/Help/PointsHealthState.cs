...
namespace TrailSimulation.Game
{
    ...
    public sealed class PointsHealthState : DialogState<MainMenuInfo>
    {
        ...
        /// </summary>
        public PointsHealthState(IWindow gameMode) : base(gameMode)
        {
        }
        ...
        {
            //parentGameMode.State = new PointsResourcesState(parentGameMode, UserData);
            SetForm(typeof (PointsResourcesState));
        }
    }
}