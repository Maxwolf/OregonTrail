...
namespace TrailSimulation.Game
{
    ...
    public sealed class RestingState : Form<TravelInfo>
    {
        /// <summary>
        ...
        /// </summary>
        public RestingState(IWindow gameMode) : base(gameMode)
        {
            ...
            switch (GameSimulationApp.Instance.Trail.CurrentLocation.Category)
            {
                ...
                case LocationCategory.RiverCrossing:
                    ...
                    else
                    {
                        ...
                        SetForm(typeof (RiverCrossState));
                    }
                    break;
                case LocationCategory.ForkInRoad:
                    // Player needs to decide on which location when road splits.
                    SetForm(typeof (ForkInRoadState));
                    break;
                default:
                    throw new ArgumentOutOfRangeException();
            }
