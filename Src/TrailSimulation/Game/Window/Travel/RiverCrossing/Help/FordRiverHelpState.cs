...
namespace TrailSimulation.Game
{
    ...
    public sealed class FordRiverHelpState : DialogState<TravelInfo>
    {
        /// <summary>
        ///     This constructor will be used by the other one
        /// </summary>
        public FordRiverHelpState(IWindow gameMode) : base(gameMode)
        {
        }
        ...
        protected override void OnDialogResponse(DialogResponse reponse)
        {
            ...
            SetForm(typeof (CaulkRiverHelpState));
        }
    }
}