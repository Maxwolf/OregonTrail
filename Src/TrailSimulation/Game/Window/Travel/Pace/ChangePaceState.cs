...
namespace TrailSimulation.Game
{
    ...
    public sealed class ChangePaceState : Form<TravelInfo>
    {
        /// <summary>
        ...
        /// </summary>
        public ChangePaceState(IWindow gameMode) : base(gameMode)
        {
        }
        ...
        public override void OnInputBufferReturned(string input)
        {
            switch (input.ToUpperInvariant())
            {
                ...
                case "3":
                    ...
                    break;
                case "4":
                    SetForm(typeof (PaceAdviceState));
                    break;
                default:
                    SetForm(typeof (ChangePaceState));
                    break;
            }
        }
    }
