...
{
    /// <summary>
    ///     Asks the user if they would like to write a custom message on their TombstoneItem for other users to see when the come
        ...
        protected override void OnDialogResponse(DialogResponse reponse)
        {
            switch (reponse)
            {
                ...
                case DialogResponse.Custom:
                    ...
                    UserData.TombstoneItem = null;
                    // Return to main menu where player can restart game, view scores, or quit the game.
                    ClearForm();
