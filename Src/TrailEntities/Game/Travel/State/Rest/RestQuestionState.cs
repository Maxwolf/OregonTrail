...
namespace TrailEntities.Game.Travel
{
    ...
    ///     the simulation.
    /// </summary>
    public sealed class RestQuestionState : ModeStateProduct
    {
        /// <summary>
        ///     This constructor will be used by the other one
        /// </summary>
        public RestQuestionState(ModeProduct gameMode, TravelInfo userData) : base(gameMode, userData)
        {
        }
        ...
        public override void OnInputBufferReturned(string input)
        {
            ...
            {
                ParentMode.AddState(typeof (RestingState));
            }
            else
            {
