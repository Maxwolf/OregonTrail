    ...
    public sealed class TrailSimulation
    {
        ...
        public void ArriveAtNextLocation()
        {
            ...
            else if (GameSimulationApp.Instance.Vehicle.Odometer >= GameSimulationApp.TRAIL_LENGTH)
            {
                ...
                GameSimulationApp.Instance.WindowManager.AddMode(ModeType.EndGame);
            }
        }
        ...
        public bool IsFirstLocation()
        {
            return LocationIndex <= 0 &&
                   ...
                   GameSimulationApp.Instance.WindowManager.RunCount[ModeType.Store] <= 1;
        }
        ...
        private void OnReachedPointOfInterest(Location nextPoint)
        {
            ...
            GameSimulationApp.Instance.WindowManager.AddMode(nextPoint.ModeType);
