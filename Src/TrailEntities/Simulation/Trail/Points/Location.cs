...
namespace TrailEntities.Simulation
{
    ...
    public class Location
    {
        ...
        /// </summary>
        private Dictionary<SimulationEntity, SimulationItem> _storeItems;
        ...
        public Location(string name, bool storeOpen = false)
        {
            ...
            _storeItems = new Dictionary<SimulationEntity, SimulationItem>(GameSimulationApp.DefaultInventory);
        ...
        /// </summary>
        public IDictionary<SimulationEntity, SimulationItem> StoreItems
        {
