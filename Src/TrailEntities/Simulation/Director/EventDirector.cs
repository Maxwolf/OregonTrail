...
namespace TrailEntities.Simulation
{
    ...
    public sealed class EventDirector
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="T:TrailEntities.Simulation.EventDirector" /> class.
        /// </summary>
        ...
        /// <summary>
        ///     Triggers an event directly by type of reference. Event must have [EventDirector] attribute to be registered in the
        ///     factory correctly.
        /// </summary>
        /// <param name="sourceEntity">Entity which will be affected by event if triggered.</param>
