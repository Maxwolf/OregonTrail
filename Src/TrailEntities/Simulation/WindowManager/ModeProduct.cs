...
namespace TrailEntities.Simulation
{
    ...
    /// </summary>
    public abstract class ModeProduct<T> : Comparer<IModeProduct>, IComparable<ModeProduct<T>>,
        IEquatable<ModeProduct<T>>,
        IEqualityComparer<ModeProduct<T>>, IModeProduct where T : struct, IComparable, IFormattable, IConvertible
    {
        /// <summary>
