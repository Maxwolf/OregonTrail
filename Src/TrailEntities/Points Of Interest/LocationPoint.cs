...
namespace TrailEntities
{
    ...
    /// </summary>
    public abstract class LocationPoint : PointOfInterest, ILocationPoint
    {
        ...
        /// </summary>
        protected LocationPoint(string name, ulong distanceLength, bool canRest, IEnumerable<Item> pointInventory = null)
