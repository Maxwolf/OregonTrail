...
namespace TrailEntities
{
    ...
    public interface IOrderedDictionary<TKey, TValue> : IOrderedDictionary, IDictionary<TKey, TValue>
    {
        ...
        ///     -or-<br />
        ///     <paramref name="index" /> is equal to or greater than <see cref="System.Collections.ICollection.Count" />.
        /// </exception>
        new TValue this[int index] { get; set; }

        /// <summary>
        ///     Adds an entry with the specified key and value into the
        ///     <see cref="IOrderedDictionary{TKey,TValue}">IOrderedDictionary&lt;TKey,TValue&gt;</see> collection with the lowest
        ///     available index.
        /// </summary>
        ...
        /// <remarks>
        ///     <para>
        ///         You can also use the <see cref="P:System.Collections.Generic.IDictionary{TKey,TValue}.Item(TKey)" /> property
        ///         to add new elements by setting the value of a key that does not exist in the
        ///         <see cref="IOrderedDictionary{TKey,TValue}">IOrderedDictionary&lt;TKey,TValue&gt;</see> collection; however, if
        ///         the specified key already exists in the
        ///         <see cref="IOrderedDictionary{TKey,TValue}">IOrderedDictionary&lt;TKey,TValue&gt;</see>, setting the
        ///         <see cref="P:Item(TKey)" /> property overwrites the old value. In contrast, the <see cref="M:Add" /> method
