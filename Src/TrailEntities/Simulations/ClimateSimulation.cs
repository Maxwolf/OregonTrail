                ...
                if (_game.Random.GetRandomBoolean())
                {
                    ...
                    switch (_game.Random.Next(5))
                    {
                        ...
                        case 4:
                            ...
                            DisasterChance = (float) _game.Random.NextDouble();
                            break;
                        case 5:
