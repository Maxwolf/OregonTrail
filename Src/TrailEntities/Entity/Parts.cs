namespace TrailEntities.Entity
{
    ...
    public static class Parts
    {
        ...
        /// </summary>
        public static SimulationItem Oxen
        {
            get { return new SimulationItem(SimulationEntity.Animal, "Oxen", "oxen", "ox", 20, 20, 0); }
        }
        ...
        /// </summary>
        public static SimulationItem Axle
        {
            get { return new SimulationItem(SimulationEntity.Axle, "Vehicle Axle", "axles", "axle", 3, 10, 0); }
        }
        ...
        /// </summary>
        public static SimulationItem Tongue
        {
            get { return new SimulationItem(SimulationEntity.Tongue, "Vehicle Tongue", "tongues", "tongue", 3, 10, 0); }
        }
        ...
        /// </summary>
        public static SimulationItem Wheel
        {
            get { return new SimulationItem(SimulationEntity.Wheel, "Vehicle Wheel", "wheels", "wheel", 3, 10, 0); }
        }
    }
}