namespace TrailEntities
{
    ...
    public static class Parts
    {
        ...
        {
            get { return new Item(SimEntity.Animal, "Oxen", "oxen", "ox", 20, 20, 0); }
        }
        ...
        {
            get { return new Item(SimEntity.Axle, "Vehicle Axle", "axles", "axle", 3, 10, 0); }
        }
        ...
        {
            get { return new Item(SimEntity.Tongue, "Vehicle Tongue", "tongues", "tongue", 3, 10, 0); }
        }
        ...
        {
            get { return new Item(SimEntity.Wheel, "Vehicle Wheel", "wheels", "wheel", 3, 10, 0); }
        }
    }
}