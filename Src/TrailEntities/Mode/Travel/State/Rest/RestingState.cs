...
namespace TrailEntities.Mode
{
    ...
    /// </summary>
    public sealed class RestingState : ModeStateProduct
    {
        /// <summary>
        ...
        /// </summary>
        public RestingState(ModeProduct gameMode, TravelInfo userData, int daysToRest) : base(gameMode, userData)
        {
            _daysToRest = daysToRest;
            // TODO: Get days to rest from user data.
        }
