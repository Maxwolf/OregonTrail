...
{
    /// <summary>
    ///     Since the view for game GameMode is separated from the actual logic being performed we need a logical way to know
    ///     what
    ///     view to attach on the view. This enum serves that purpose, it is required to add any new game GameMode the
    ///     simulation
    ///     needs to know about to this enumeration along with game gameMode attribute to define required classes for game
    ///     gameMode.
    /// </summary>
    public enum GameMode
    {
        ...
        /// <summary>
        ///     Random event gameMode is attached by the event director which then listens for the event it will throw at it over
        ///     event
