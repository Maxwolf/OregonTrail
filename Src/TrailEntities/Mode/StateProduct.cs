...
namespace TrailEntities.Mode
{
    ...
    /// </summary>
    public abstract class StateProduct : Comparer<StateProduct>, IComparable<StateProduct>, IEquatable<StateProduct>, IEqualityComparer<StateProduct>
    {
        /// <summary>
        ///     This constructor will be used by the other one
        /// </summary>
        protected StateProduct(ModeProduct gameMode, object userData)
        {
            ParentMode = gameMode;
            UserData = userData;
        }
        ...
        public int CompareTo(StateProduct other)
        {
        ...
        /// </returns>
        public bool Equals(StateProduct x, StateProduct y)
        {
            return x.Equals(y);
        }
        ...
        /// </exception>
        public int GetHashCode(StateProduct obj)
        {
        ...
        /// </returns>
        /// <param name="other">An object to compare with this object.</param>
        public bool Equals(StateProduct other)
        {
        ...
        public override int Compare(StateProduct x, StateProduct y)
        {
