...
namespace TrailEntities.Mode
{
    ...
    /// </summary>
    public abstract class ModeStateProduct : Comparer<ModeStateProduct>, IComparable<ModeStateProduct>, IEquatable<ModeStateProduct>, IEqualityComparer<ModeStateProduct>
    {
        /// <summary>
        ///     This constructor will be used by the other one
        /// </summary>
        protected ModeStateProduct(ModeProduct gameMode, object userData)
        {
            ParentMode = gameMode;
            UserData = userData;
        }
        ...
        /// </summary>
        protected ModeProduct ParentMode { get; }
        ...
        public int CompareTo(ModeStateProduct other)
        {
        ...
        /// </returns>
        public bool Equals(ModeStateProduct x, ModeStateProduct y)
        {
            return x.Equals(y);
        }
        ...
        /// </exception>
        public int GetHashCode(ModeStateProduct obj)
        {
        ...
        /// </returns>
        /// <param name="other">An object to compare with this object.</param>
        public bool Equals(ModeStateProduct other)
        {
        ...
        /// </summary>
        protected internal virtual void TickState()
        {
        ...
        public override int Compare(ModeStateProduct x, ModeStateProduct y)
        {
