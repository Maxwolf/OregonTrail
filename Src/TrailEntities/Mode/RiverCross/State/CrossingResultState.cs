...
namespace TrailEntities.Mode
{
    ...
    /// </summary>
    public sealed class CrossingResultState : ModeStateProduct
    {
        ...
        /// </summary>
        public CrossingResultState(ModeProduct gameMode, RiverCrossInfo userData) : base(gameMode, userData)
        {
