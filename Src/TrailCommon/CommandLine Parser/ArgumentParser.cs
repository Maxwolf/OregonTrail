...
{
    /// <summary>
    ///     Parses arguments in meaningful ways allowing them to be cast any type that may be required by program startup.
    /// </summary>
    public class ArgumentParser
    {
        ...
        /// <summary>
        ///     Determines if the parsed arguments are empty, meaning there are no arguments for program start only the program
        ///     name was used.
        /// </summary>
        public bool IsEmpty()
        {
