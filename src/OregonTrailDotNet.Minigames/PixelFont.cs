...
namespace OregonTrailDotNet.Minigames
{
    ...
    public static class PixelFont
    {
        ...
        /// <param name="text">The line; lower case is folded up, unknown characters become blanks.</param>
        ...
        /// </summary>
        /// <param name="target">Buffer to draw into.</param>
        /// <param name="text">The line; folded to upper case, unknown characters become blanks.</param>
